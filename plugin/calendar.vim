...
function! s:InsertDate()
  ...
  let months = map(range(86400*2,86400*365,86400*31),'strftime("%B",v:val)')
...
function! Calendar(...)
  ...
  execute 'nnoremap <silent> <buffer> i :call <SID>CalendarDoAction("i")<cr>'
